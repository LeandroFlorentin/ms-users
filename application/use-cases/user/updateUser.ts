...
import { IUserDecodedToken, IUserDB } from '&/application/dtos/users/users.dto';
import { hashPassword } from '&/shared';
import updateUserSchema from '&/infrastructure/validation/schemas/user/update.zod';

export const updateUser = async (userRepository: UserRepository, cacheRepository: ICacheRepository, body: IUserDB, id: number, user: IUserDecodedToken): Promise<void> => {
